...
public final class BundledPluginTunnel: TunnelProvider {
    ...
    public static func defaultPluginPath() -> String? {
    ...
    public func checkAvailability() -> TunnelProviderStatus {
    ...
    public static func pluginArguments(
        session: SSMSessionResponse,
        region: String,
        instanceId: String,
        localPort: Int,
        ...
        let parameters: [String: Any] = [
            "Target": instanceId,
            "DocumentName": SSMDocument.portForward,
            "Parameters": [
...
public final class BundledPluginTunnelHandle: TunnelHandle, @unchecked Sendable {
    ...
    public init(process: SpawnedPluginProcess, gracePeriod: Duration, pollInterval: Duration) {
