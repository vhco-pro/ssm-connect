...
public final class ProfileStore {
    ...
    @discardableResult
    public func duplicateProfile(_ id: UUID) -> ConnectionProfile? {
    ...
    public func importableProfiles(parser: AWSConfigParser? = AWSConfigParser.loadDefault()) -> [ConnectionProfile] {
