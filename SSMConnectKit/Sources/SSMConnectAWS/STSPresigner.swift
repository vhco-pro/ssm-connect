...
public struct STSPresigner {
    public let region: String

    public var host: String { "sts.\(region).amazonaws.com" }

    /// Produces the presigned URL. `now` is injectable for deterministic tests.
    public func presignedGetCallerIdentityURL(
    ...
    public static func signingKey(secret: String, dateStamp: String, region: String, service: String) -> SymmetricKey {
    ...
    public static func hexHMAC(key: SymmetricKey, data: Data) -> String {
    ...
    public static func rfc3986(_ s: String) -> String {
