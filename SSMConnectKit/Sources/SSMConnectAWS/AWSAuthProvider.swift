...
public final class AWSAuthProvider: AuthProviding {
    public typealias OIDCClientFactory = @Sendable (_ ssoRegion: String) throws -> SSOOIDCClienting
    public typealias SSOClientFactory = @Sendable (_ ssoRegion: String) throws -> SSOClienting
    ...
    public static func isRoleAccessDenied(_ error: Error) -> Bool {
