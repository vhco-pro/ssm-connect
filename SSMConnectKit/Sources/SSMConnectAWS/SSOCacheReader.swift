...
public protocol SSOCacheReading: Sendable {
...
public struct SSOCacheReader: SSOCacheReading {
    ...
    public func token(startUrl: String, region: String) throws -> SSOToken? {
        guard let match = try matchingFile(startUrl: startUrl, region: region) else { return nil }
        return match.token
    }

    public func update(_ token: SSOToken) throws {
    ...
    public static func cacheKey(for startUrl: String) -> String {
