...
public protocol TunnelHandle: Sendable {
...
public enum TunnelProviderStatus: Equatable, Sendable {
    case available
...
public enum TunnelDropReason: Equatable, Sendable {
...
public enum TunnelError: LocalizedError, Equatable {
    case pluginMissing(path: String)
    case pluginNotExecutable(path: String)
