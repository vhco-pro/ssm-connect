...
public protocol DCVLaunching: Sendable {
...
public enum DCVError: LocalizedError, Equatable {
...
public protocol DCVViewerLocating: Sendable {
...
public protocol DCVConnectionFileStore: Sendable {
...
public protocol DCVViewerOpening: Sendable {
