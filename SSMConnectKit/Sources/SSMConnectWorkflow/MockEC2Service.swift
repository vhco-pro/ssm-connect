...
public final class MockEC2Service: EC2Providing, @unchecked Sendable {
    public var resolveResult: Result<EC2Instance, Error> = .success(.stub())
    public var startError: Error?
    public var stopError: Error?
    public var pollResult: Result<EC2Instance, Error> = .success(.stub(state: .running))
